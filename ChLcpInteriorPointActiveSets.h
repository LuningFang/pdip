...
#ifndef CHLCPINTERIORPOINTACTIVESETS_H
#define CHLCPINTERIORPOINTACTIVESETS_H
...
class ChApi ChLcpInteriorPointActiveSets : public ChLcpIterativeSolver
{
protected:
			//
			// DATA
...
public:
	...
	virtual ~ChLcpInteriorPointActiveSets() { fprintf(stderr, "destrctor called!\n");};
